...
ArrayList<Productos> compras;
    ...
    public Clientes(double dinero, ArrayList<Productos> compras, ArrayList<String> ID, ArrayList<String> username, ArrayList<String> contra, String Correo, Date nacimiento) {
